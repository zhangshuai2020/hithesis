...
\chapter[编队重构]{绕飞编队约束重构}[Fly-around Formation Reconfiguration]	
\section{常微分方程初值解}[Initial Value Problem]

\section{数值方法}[Numerical Methods]
\section{模型}[]
\section{应用案例}[Sample Case]
\subsection{同步转移轨道编队重构}[GTO Formation Reconfiguration]
\subsection{闪电轨道交会编队重构}[Molniya Formation Reconfiguration]
